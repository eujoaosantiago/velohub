...
import { Vehicle, Buyer } from '@/shared/types';
import { Button } from './ui/Button';
import { X, User, FileText, Phone, Calendar, ArrowRightLeft, ShieldCheck, Printer, CheckCircle, AlertCircle } from 'lucide-react';
import { isValidCPF, formatCurrency, maskCurrencyInput, parseCurrencyInput, maskCPF, maskPhone, getBrazilDateISO, parseISODate, fetchCepInfo, formatDateBR } from '@/shared/lib/utils';
